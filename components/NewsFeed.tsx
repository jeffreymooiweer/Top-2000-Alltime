          ...
          >
            ...
            <div className="p-5 flex-1 flex flex-col">
              ...
              <div className="mt-4 flex items-center text-[#d00018] font-bold text-xs uppercase tracking-wider group-hover:underline">
                Lees Meer 
                <svg aria-hidden="true" className="w-4 h-4 ml-1" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 8l4 4m0 0l-4 4m4-4H3" /></svg>
              </div>
            </div>
          </a>
        ))}
